...
import com.ddenfi.mystoryapp.utils.ConstantValue.INITIAL_PAGE_INDEX
...
class StoryRemoteMediator (
    ...
    override suspend fun load(
        ...
        try {
            val responseData = apiService.getAllStoriesPaged(token, page, state.config.pageSize)
